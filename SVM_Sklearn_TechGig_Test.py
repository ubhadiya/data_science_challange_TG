...
train = pd.read_csv("/Users/kamlesh/Documents/Technical Data/Python_example/PythonFirst/TechGig/train.csv")

test = pd.read_csv("/Users/kamlesh/Documents/Technical Data/Python_example/PythonFirst/TechGig/test.csv")
...
clf.fit(X_train_tfidf, train['StringToExtract'])
